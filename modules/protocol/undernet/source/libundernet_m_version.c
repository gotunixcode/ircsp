...
/*
---------------------------------------------------------------------------------------------------------------------------------
 FUNCTION       |    libundernet_m_version ()
                |
 DESCRIPTION    |    Undernet Protocol (m_version)
                |    This function will handle Server Message: VERSION [V]
                |
                |        [ircsp.c:725:ircsp_mainloop()]: Socket (READ): ADAAY V :AI
                |
                |
...
---------------------------------------------------------------------------------------------------------------------------------
*/
int libundernet_m_version (sBuf)
	char		*sBuf;
{
	if (DEBUG)
	{
